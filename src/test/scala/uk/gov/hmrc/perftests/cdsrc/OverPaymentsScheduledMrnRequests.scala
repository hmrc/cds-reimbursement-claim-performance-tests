...
object OverPaymentsScheduledMrnRequests extends ServicesConfiguration with RequestUtils {
  ...
  def postOverpaymentsScheduledChooseHowManyMrnsPage: HttpRequestBuilder =
    http("post overpayments scheduled choose how many mrns page")
      ...
      .formParam("overpayments.choose-how-many-mrns", _ => "Scheduled")
      .check(status.is(303))
  ...
  def postOverpaymentsScheduledChooseBasisForClaimPage: HttpRequestBuilder =
    http("post overpayments scheduled choose basis for claim page")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .formParam("select-basis-for-claim", _ => "DutySuspension")
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/enter-additional-details": String))
  ...
  def postScheduledMrnExciseSelectDutiesPage: HttpRequestBuilder =
    http("post overpayments scheduled select excise duty types page")
      ...
      .formParam("select-excise-categories[]", _ => "wine")
      .formParam("select-excise-categories[]", _ => "made-wine")
      .formParam("select-excise-categories[]", _ => "low-alcohol-beverages")
      .formParam("select-excise-categories[]", _ => "spirits")
      .formParam("select-excise-categories[]", _ => "cider-perry")
      .formParam("select-excise-categories[]", _ => "other-fermented-products")
      .formParam("select-excise-categories[]", _ => "hydrocarbon-oils")
      .formParam("select-excise-categories[]", _ => "biofuels")
      .formParam("select-excise-categories[]", _ => "miscellaneous-road-fuels")
      .formParam("select-excise-categories[]", _ => "tobacco")
      .formParam("select-excise-categories[]", _ => "climate-change-levy")
      .check(status.in(303))
      .check(
        header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/select-duties/excise-duty/beer": String)
      )
  ...
  def postOverpaymentsScheduledMrnSelectDutiesBeerPage: HttpRequestBuilder =
    http("post overpayments select duties beer page")
      ...
      .check(status.is(303))
      .check(
        header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/enter-claim/excise-duty/440": String)
      )
  ...
  def postOverpaymentsScheduledMrnSelectDutiesWinePage: HttpRequestBuilder =
    http("post overpayments select duties wine page")
      ...
      .check(status.is(303))
      .check(
        header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/enter-claim/excise-duty/413": String)
      )
  ...
  def postOverpaymentsScheduledMrnSelectDutiesMadeWinePage: HttpRequestBuilder =
    http("post overpayments select duties made wine page")
      ...
      .check(status.is(303))
      .check(
        header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/enter-claim/excise-duty/423": String)
      )
  ...
  def postOverpaymentsScheduledMrnSelectDutiesLowAlcoholBeveragesPage: HttpRequestBuilder =
    http("post overpayments select duties alcohol page")
      ...
      .check(status.is(303))
      .check(
        header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/enter-claim/excise-duty/435": String)
      )
  ...
  def postOverpaymentsScheduledMrnSelectDutiesSpiritsPage: HttpRequestBuilder =
    http("post overpayments select duties spirits page")
      ...
      .check(status.is(303))
      .check(
        header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/enter-claim/excise-duty/462": String)
      )
  ...
  def postOverpaymentsScheduledMrnSelectDutiesCiderPerryPage: HttpRequestBuilder =
    http("post overpayments select duties cider page")
      ...
      .check(status.is(303))
      .check(
        header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/enter-claim/excise-duty/483": String)
      )
  ...
  def postOverpaymentsScheduledMrnSelectDutiesOtherFermentedProductsPage: HttpRequestBuilder =
    http("post overpayments select duties other fermented products page")
      ...
      .check(status.is(303))
      .check(
        header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/enter-claim/excise-duty/334": String)
      )
  ...
  def postOverpaymentsScheduledMrnSelectDutiesHydrocarbonOilsPage: HttpRequestBuilder =
    http("post overpayments select duties hydrocarbon oils page")
      ...
      .check(status.is(303))
      .check(
        header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/enter-claim/excise-duty/551": String)
      )
  ...
  def postOverpaymentsScheduledMrnSelectDutiesBiofuelsPage: HttpRequestBuilder =
    http("post overpayments select duties biofuels page")
      ...
      .check(status.is(303))
      .check(
        header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/enter-claim/excise-duty/589": String)
      )
  ...
  def postOverpaymentsScheduledMrnSelectDutiesMiscellaneousPage: HttpRequestBuilder =
    http("post overpayments select duties road fuels page")
      ...
      .check(status.is(303))
      .check(
        header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/enter-claim/excise-duty/592": String)
      )
  ...
  def postOverpaymentsScheduledMrnSelectDutiesTobaccoPage: HttpRequestBuilder =
    http("post overpayments select duties tobacco page")
      ...
      .check(status.is(303))
      .check(
        header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/enter-claim/excise-duty/611": String)
      )
  ...
  def postOverpaymentsScheduledMrnSelectDutiesClimatePage: HttpRequestBuilder =
    http("post overpayments select duties climate change levy page")
      ...
      .check(status.is(303))
      .check(
        header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/enter-claim/excise-duty/99A": String)
      )
  ...
  def postOverpaymentsScheduledMrnBeerPage: HttpRequestBuilder =
    http("post overpayments select duties beer tax page")
      ...
      .check(status.is(303))
      .check(
        header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/select-duties/excise-duty/wine": String)
      )
  ...
  def postOverpaymentsScheduledMrnWinePage: HttpRequestBuilder =
    http("post overpayments select duties wine tax page")
      ...
      .check(status.is(303))
      .check(
        header("Location".asInstanceOf[CharSequence])
          .is(s"/$route1/scheduled/select-duties/excise-duty/made-wine": String)
      )
  ...
  def postOverpaymentsScheduledMrnMadeWinePage: HttpRequestBuilder =
    http("post overpayments select duties made wine tax page")
      ...
      .check(
        header("Location".asInstanceOf[CharSequence])
          .is(s"/$route1/scheduled/select-duties/excise-duty/low-alcohol-beverages": String)
      )
  ...
  def postOverpaymentsScheduledMrnLowAlcoholPage: HttpRequestBuilder =
    http("post overpayments select duties alcohol tax page")
      ...
      .check(
        header("Location".asInstanceOf[CharSequence])
          .is(s"/$route1/scheduled/select-duties/excise-duty/spirits": String)
      )
  ...
  def postOverpaymentsScheduledMrnSpiritsPage: HttpRequestBuilder =
    http("post overpayments select duties spirits tax page")
      ...
      .check(
        header("Location".asInstanceOf[CharSequence])
          .is(s"/$route1/scheduled/select-duties/excise-duty/cider-perry": String)
      )
  ...
  def postOverpaymentsScheduledMrnCiderPerryPage: HttpRequestBuilder =
    http("post overpayments select duties cider tax page")
      ...
      .check(
        header("Location".asInstanceOf[CharSequence])
          .is(s"/$route1/scheduled/select-duties/excise-duty/other-fermented-products": String)
      )
  ...
  def postOverpaymentsScheduledMrnOtherFermentedProductsPage: HttpRequestBuilder =
    http("post overpayments select duties other fermented products tax page")
      ...
      .check(
        header("Location".asInstanceOf[CharSequence])
          .is(s"/$route1/scheduled/select-duties/excise-duty/hydrocarbon-oils": String)
      )
  ...
  def postOverpaymentsScheduledMrnHydroOilsPage: HttpRequestBuilder =
    http("post overpayments select duties hydrocarbon oils tax page")
      ...
      .check(
        header("Location".asInstanceOf[CharSequence])
          .is(s"/$route1/scheduled/select-duties/excise-duty/biofuels": String)
      )
  ...
  def postOverpaymentsScheduledMrnBiofuelsPage: HttpRequestBuilder =
    http("post overpayments select duties biofuels tax page")
      ...
      .check(
        header("Location".asInstanceOf[CharSequence])
          .is(s"/$route1/scheduled/select-duties/excise-duty/miscellaneous-road-fuels": String)
      )
  ...
  def postOverpaymentsScheduledMrnRoadFuelsPage: HttpRequestBuilder =
    http("post overpayments select duties miscellaneous road tax page")
      ...
      .check(
        header("Location".asInstanceOf[CharSequence])
          .is(s"/$route1/scheduled/select-duties/excise-duty/tobacco": String)
      )
  ...
  def postOverpaymentsScheduledMrnTobaccoPage: HttpRequestBuilder =
    http("post overpayments select duties tobacco tax page")
      ...
      .check(
        header("Location".asInstanceOf[CharSequence])
          .is(s"/$route1/scheduled/select-duties/excise-duty/climate-change-levy": String)
      )
  ...
  def postOverpaymentsScheduledMRNChoosePayeeTypePage: HttpRequestBuilder =
    http("post overpayments scheduled bank account type")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .formParam("choose-payee-type", _ => "Consignee")
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/enter-bank-account-details": String))
  ...
  def postOverpaymentsScheduledEnterBankAccountDetailsPage: HttpRequestBuilder =
    http("post overpayments scheduled enter bank account details page")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .formParam("enter-bank-account-details.account-name", _ => "Natwest")
      .formParam("enter-bank-account-details.sort-code", _ => "456789")
      .formParam("enter-bank-account-details.account-number", _ => "45678901")
      .check(status.is(303))
  ...
  def postOverpaymentsScheduledChooseFileTypesPage: HttpRequestBuilder =
    http("post overpayments rejected goods scheduled choose file type page")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .formParam("choose-file-type", _ => "PackingList")
      .check(status.is(303))
  ...
  def postOverpaymentsScheduledChangeContactDetailsPage: HttpRequestBuilder =
    http("post overpayments scheduled change contact details page")
      ...
      .check(status.is(303))
      .check(
        header("Location".asInstanceOf[CharSequence]).is(s"/$route1/scheduled/claimant-details/lookup-address": String)
      )
