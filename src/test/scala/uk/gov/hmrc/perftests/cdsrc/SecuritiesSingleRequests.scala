...
object SecuritiesSingleRequests extends ServicesConfiguration with RequestUtils {
  ...
  def postSecuritiesSelectClaimTypePage: HttpRequestBuilder =
    http("post securities select claim type page")
      ...
      .formParam("choose-claim-type", _ => "Securities")
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/enter-movement-reference-number": String))
  ...
  def postSecuritiesEnterMovementReferenceNumberPage(MRN: String): HttpRequestBuilder =
    http("post securities enter movement reference number page")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .formParam("enter-movement-reference-number", _ => MRN)
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/choose-reason-for-security": String))
  ...
  def postSecuritiesReasonForSecurityPage(
    ...
    http("post securities choose reason for security page")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .formParam("choose-reason-for-security.securities", _ => reasonForSecurityUrl)
      .check(status.is(303))
  }
  ...
  def postSecuritiesTotalImportDischargedForBod4Page: HttpRequestBuilder =
    http("post securities check total import discharged for bod4 page")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .formParam("check-total-import-discharged", _ => "true")
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/upload-bill-of-discharge4": String))
  ...
  def postSecuritiesBODChooseFileTypePage: HttpRequestBuilder =
    http("post BOD upload support evidence page")
      ...
      .bodyPart(RawFileBodyPart("file", _ => "data/pixel.jpg"))
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/add-other-documents": String))
  ...
  def postSecuritiesTotalImportDischargedForBod3Page: HttpRequestBuilder =
    http("post securities check total import discharged page")
      ...
      .formParam("check-total-import-discharged", _ => "true")
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/upload-bill-of-discharge3": String))
  ...
  def postAddOtherDocuments: HttpRequestBuilder =
    http("post add other documents to support your claim")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .formParam("add-other-documents", _ => "false")
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/choose-payee-type": String))
  ...
  def postEnterAdditionalDetails: HttpRequestBuilder =
    http("add other documents to support your claim")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .formParam("enter-additional-details", _ => "Test")
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/change-contact-details": String))
  ...
  def postSecuritiesCheckDeclarationDetailsPage: HttpRequestBuilder =
    http("post securities check declaration details page")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/confirm-full-repayment": String))
  ...
  def postSecuritiesTACheckDeclarationDetailsPage: HttpRequestBuilder =
    http("post securities TA next check declaration details page")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/have-your-documents-ready": String))
  ...
  def postSecuritiesConfirmPaymentExportMethodPage: HttpRequestBuilder =
    http("post securities Confirm Payment export method page")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .formParam("confirm-full-repayment-2", _ => "false")
      .formParam("choose-export-method", _ => "ExportedInSingleShipment")
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/partial-claims": String))
  ...
  def postSecuritiesPartialClaimPage: HttpRequestBuilder =
    http("post securities Partial Claim page")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .formParam("partial-claims", _ => "true")
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/select-duties": String))
  ...
  def postSecuritiesSelectDutyPage: HttpRequestBuilder =
    http("post securities Select Duty page")
      ...
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/enter-claim/ABC0123456/A00": String))
  ...
  def postSecuritiesEnterClaimTaxCodePage: HttpRequestBuilder =
    http("post securities enter claim tax code page")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .formParam("enter-claim-amount", _ => "90")
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/confirm-full-repayment/ABC0123456": String))
  ...
  def postSecuritiesExportMethodPage: HttpRequestBuilder =
    http("post securities export method page")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .formParam("choose-export-method[]", _ => "ExportedInSingleOrMultipleShipments")
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/enter-export-movement-reference-number": String))
  ...
  def postSecuritiesExportMRNPage: HttpRequestBuilder =
    http("post securities export MRN page")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .formParam("enter-export-movement-reference-number", _ => "41ABCDEFGHIJKLMNO1")
      .formParam("enter-export-movement-reference-number", _ => "false")
      .check(status.is(303))
  ...
  def postSecuritiesChooseFileTypePage: HttpRequestBuilder =
    http("post securities choose file type page")
      ...
      .formParam("csrfToken", session => session("csrfToken").as[String])
      .formParam("choose-file-type", _ => "ImportDeclaration")
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/choose-files": String))
  ...
  def postSecuritiesClaimantDetailsPage: HttpRequestBuilder =
    http("post securities claimant details page")
      ...
      .check(status.is(303))
      .check(header("Location".asInstanceOf[CharSequence]).is(s"/$route1/claimant-details/lookup-address": String))
